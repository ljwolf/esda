...
def _ripley_test(
    ...
    tree = build_best_tree(coordinates, metric=metric)
    hull = _prepare_hull(tree.data)
    ...
    return result_container(observed_support, statistic, pvalue, reference_distribution)
